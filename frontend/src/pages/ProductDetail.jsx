...
export default function ProductDetail() {
  ...
  async function addToCart() {
    try {
      ...
      setFeedback({ type: "success", message: "Adicionado ao carrinho!" });
    } catch (e) {
      setFeedback({
        type: "error",
        message: e.response?.data?.message || "Erro ao adicionar ao carrinho",
      });
    }
  }
  ...
  const img =
    p.images?.[0] || "https://via.placeholder.com/800x600?text=Produto";
